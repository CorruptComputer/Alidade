...
/// <inheritdoc />
public class OrthogonalizeNodes(EditBufferStateService editBufferState) : IRequestHandler<OrthogonalizeNodes.Command, CommandResult>
{
    static OrthogonalizeNodes() => UndoDescriptions.Register<Command>("Orthogonalize");

    /// <summary>
    ///   Applies pre-computed node position corrections to orthogonalize a building polygon.
    /// </summary>
